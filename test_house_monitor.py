...
from house_monitor import COMMUNITY, DEFAULT_SOURCE_URL, parse_listings


class ListingParserTests(unittest.TestCase):
    def test_default_source_is_the_target_community_search(self):
        self.assertTrue(DEFAULT_SOURCE_URL.startswith("https://fz.anjuke.com/sale/"))
        self.assertIn("comm_id=1193408", DEFAULT_SOURCE_URL)
